...
export const HERO_CONTENT = `Je suis un étudiant passionné,  spécialisé dans la création d'applications web robustes et évolutives. Tout en étant en pleine formation, j'ai acquis des compétences en JavaScript, React, Vue, Angular, et PHP / MySQL. Mon objectif est de mettre à profit mon apprentissage pour concevoir des solutions innovantes qui stimulent la croissance des entreprises et offrent des expériences utilisateur exceptionnelles.`;
